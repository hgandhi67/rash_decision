...
class PlaceApiModel {
//   final List<Object> html_attributions;
    List<Result> results;
    String status;

//    PlaceApiModel({this.html_attributions, this.results, this.status});
    PlaceApiModel({ this.results, this.status});

    factory PlaceApiModel.fromJson(Map<String, dynamic> json) {
        return PlaceApiModel(
...
class Result {
    ...
    Result({this.phone_number,this.geometry, this.icon, this.id, this.name, this.opening_hours, this.photos, this.place_id, this.plus_code, this.rating, this.reference, this.scope, this.types, this.user_ratings_total, this.vicinity});
